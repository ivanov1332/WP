...
public class EmployeeController {
    ...
    public String showAdd(Model model) {
        List<Skill> skills = skillService.listAll();
        model.addAttribute("skills", skills);
        model.addAttribute("employeesTypes", Arrays.stream(EmployeeType.values()).collect(Collectors.toList()));
        model.addAttribute("employees", service.listAll());
//        System.out.println(Arrays.stream(EmployeeType.values()).collect(Collectors.toList()));
        return "form";
    }
